...
public class Editsdt implements Initializable {

    public TextField editid, editnum;
    public ComboBox<String> edittype;
    ...
    public void Editsdt(MouseEvent event) throws Exception {
        String id = editid.getText();
        String num = editnum.getText();
        String type = edittype.getValue().toString();
        if (id == null) id = "";
        ...
        strsql = "UPDATE so_dien_thoai SET MaSo = '" + id + "', SoDienThoai = '" + num + "', PhanLoai = '" + type +"' " +
                "WHERE MaSo = '" + sid + "' AND SoDienThoai = '" + snum + "'";
        comm.execute(strsql);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        edittype.setItems(FXCollections.observableArrayList("Giáo viên", "Lớp trưởng", "GV chủ nhiệm", "Nhân viên"));
        Sodienthoai.setSdt(Controller.EditSdt, editid, editnum, edittype);
    }
}
